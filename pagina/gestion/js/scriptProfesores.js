  ...
  alumnos.forEach(alumno => {
    ...
    <a href="perfil.html?id=${alumno.id}" class="text-decoration-none enlace-alumno" onmouseover="cambiarImagen(this)" onmouseout="restaurarImagen(this)">
        <div class="card h-100">
            <!-- Product image-->
            <img src="assets/logo-profesor-2.png" alt="Imagen 1" class="imagen-alumno">
            <!-- Product details-->
...
const url = 'http://127.0.0.1:8000/api/usuarios/2';
const metodo = 'GET';
const datos = null;
...
function cambiarImagen(elemento) {
  ...
  imagen.setAttribute("src", "assets/logo-profesor-3.png");
}

function restaurarImagen(elemento) {
  var imagen = elemento.querySelector('.imagen-alumno');
  imagen.setAttribute("src", "assets/logo-profesor-2.png");
}
